...
import com.xinba.wechat.common.bean.WxJsapiSignature;
...
import com.xinba.wechat.common.util.DataUtils;
import com.xinba.wechat.common.util.RandomUtils;
import com.xinba.wechat.common.util.crypto.SHA1;
import com.xinba.wechat.common.util.http.*;
import com.xinba.wechat.mp.api.*;
import com.xinba.wechat.mp.bean.WxMpSemanticQuery;
...
public abstract class BaseWxMpServiceImpl<H, P> implements WxMpService, RequestHttp<H, P> {
    ...
    public String getJsapiTicket(boolean forceRefresh) throws WxErrorException {
        ...
        try {
            ...
            if (this.getWxMpConfigStorage().isJsapiTicketExpired()) {
                ...
                String jsapiTicket = tmpJsonElement.getString("ticket");
    ...
    public String shortUrl(String longUrl) throws WxErrorException {
        ...
        o.put("action", "long2short");
        o.put("long_url", longUrl);
        String responseContent = this.post(WxMpService.SHORTURL_API_URL, o.toString());
        JSONObject tmpJsonElement = JSONObject.parseObject(responseContent);
        return tmpJsonElement.getString("short_url");
    }
    ...
    public String[] getCallbackIP() throws WxErrorException {
        ...
        JSONObject tmpJsonElement = JSON.parseObject(responseContent);
        JSONArray ipList = tmpJsonElement.getJSONArray("ip_list");
        String[] ipArray = new String[ipList.size()];
        for (int i = 0; i < ipList.size(); i++) {
            ipArray[i] = ipList.getString(i);
        }
        return ipArray;
    }
