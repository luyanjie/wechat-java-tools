...
public interface WxMpMaterialService {
   ...
   * </pre>
   *
   * @param mediaType 媒体类型, 请看{@link com.xinba.wechat.common.api.WxConstant}
   * @param file      文件对象
   ...
   *
   * @param mediaType   媒体类型, 请看{@link com.xinba.wechat.common.api.WxConstant}
   * @param fileType    文件类型，请看{@link com.xinba.wechat.common.api.WxConstant}
   ...
   * </pre>
   *
   * @param mediaType 媒体类型, 请看{@link com.xinba.wechat.common.api.WxConstantt}
   ...
   * </pre>
   *
   * @param type   媒体类型, 请看{@link com.xinba.wechat.common.api.WxConstant}
   * @param offset 从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
   * @param count  返回素材的数量，取值在1到20之间
   */
