...
import com.xinba.wechat.mp.api.WxMpDataCubeService;
import com.xinba.wechat.mp.api.WxMpService;
import com.xinba.wechat.mp.bean.datacube.*;
...
public class WxMpDataCubeServiceImpl implements WxMpDataCubeService {
    ...
    private String buildParams(Date beginDate, Date endDate) {
        ...
        param.put("begin_date", this.dateFormat.format(beginDate));
        param.put("end_date", this.dateFormat.format(endDate));
