...
import com.xinba.wechat.common.util.http.apache.ApacheHttpClientBuilder;
import com.xinba.wechat.common.util.http.apache.DefaultApacheHttpClientBuilder;
...
public class WxMpServiceHttpClientImpl extends BaseWxMpServiceImpl<CloseableHttpClient, HttpHost> {
    ...
    public String uMengApi() throws WxErrorException {
        return null;
    }
}
