...
import com.xinba.wechat.mp.api.WxMpMemberCardService;
import com.xinba.wechat.mp.api.WxMpService;
import com.xinba.wechat.mp.bean.card.*;
import com.xinba.wechat.mp.bean.card.enums.BusinessServiceType;
import com.xinba.wechat.mp.bean.card.enums.CardColor;
import com.xinba.wechat.mp.bean.card.enums.DateInfoType;
import com.xinba.wechat.mp.bean.membercard.*;
...
public class WxMpMemberCardServiceImpl implements WxMpMemberCardService {
  ...
  public WxMpCardCreateResult createMemberCard(String createJson) throws WxErrorException {
    WxMpMemberCardCreateMessage createMessage = JSON.parseObject(createJson, WxMpMemberCardCreateMessage.class);
  ...
  public WxMpCardCreateResult createMemberCard(WxMpMemberCardCreateMessage createMessageMessage) throws WxErrorException {
    ...
    if (!validResult.isSuccess()){
      return validResult;}
    String response = this.wxMpService.post(MEMBER_CARD_CREAET, JsonUtils.toJSONString(createMessageMessage));
...
//    }
  ...
  public String activateMemberCard(WxMpMemberCardActivatedMessage activatedMessage) throws WxErrorException {
    return this.wxMpService.post(MEMBER_CARD_ACTIVATE, JsonUtils.toJSONString(activatedMessage));
  }
  ...
  public WxMpMemberCardUserInfoResult getUserInfo(String cardId, String code) throws WxErrorException {
    ...
    return JSON.parseObject(responseContent,WxMpMemberCardUserInfoResult.class);
  }
  ...
  public WxMpMemberCardUpdateResult updateUserMemberCard(WxMpMemberCardUpdateMessage updateUserMessage)
    ...
    String responseContent = this.getWxMpService().post(MEMBER_CARD_UPDATE_USER, JsonUtils.toJSONString(updateUserMessage));
    return JSON.parseObject(responseContent,WxMpMemberCardUpdateResult.class);
  }
  ...
  public MemberCardActivateUserFormResult setActivateUserForm(MemberCardActivateUserFormRequest userFormRequest) throws WxErrorException {
    String responseContent = this.getWxMpService().post(MEMBER_CARD_ACTIVATEUSERFORM, JsonUtils.toJSONString(userFormRequest));
