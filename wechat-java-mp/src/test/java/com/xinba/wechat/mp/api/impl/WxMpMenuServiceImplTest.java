...
public class WxMpMenuServiceImplTest {
    ...
    public Object[][] getMenu() {
        ...
        button1.setType(WxConstant.MenuButtonType.CLICK);
        button1.setName("今日歌曲");
        button1.setKey("V1001_TODAY_MUSIC");

//    WxMenuButton button2 = new WxMenuButton();
//    button2.setType(WxConstant.MenuButtonType.MINIPROGRAM);
//    button2.setName("小程序");
...
//    menu.getButtons().add(button2);
        ...
        button31.setType(WxConstant.MenuButtonType.VIEW);
        button31.setName("搜索");
        button31.setUrl("http://www.soso.com/");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(WxConstant.MenuButtonType.VIEW);
        button32.setName("视频");
        button32.setUrl("http://v.qq.com/");

        WxMenuButton button33 = new WxMenuButton();
        button33.setType(WxConstant.MenuButtonType.CLICK);
