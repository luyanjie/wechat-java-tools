...
public class WxMpKefuMessageTest {
    ...
    public void testTextReply() {
        ...
        reply.setMsgType(WxConstant.KefuMsgType.TEXT);
    ...
    public void testImageReply() {
        WxMpKefuMessage reply = new WxMpKefuMessage();
        reply.setToUser("OPENID");
        reply.setMsgType(WxConstant.KefuMsgType.IMAGE);
    ...
    public void testVoiceReply() {
        WxMpKefuMessage reply = new WxMpKefuMessage();
        reply.setToUser("OPENID");
        reply.setMsgType(WxConstant.KefuMsgType.VOICE);
        reply.setMediaId("MEDIA_ID");
        Assert.assertEquals(reply.toJson(),
    ...
    public void testVideoReply() {
        WxMpKefuMessage reply = new WxMpKefuMessage();
        reply.setToUser("OPENID");
        reply.setMsgType(WxConstant.KefuMsgType.VIDEO);
        reply.setMediaId("MEDIA_ID");
    ...
    public void testMusicReply() {
        WxMpKefuMessage reply = new WxMpKefuMessage();
        reply.setToUser("OPENID");
        reply.setMsgType(WxConstant.KefuMsgType.MUSIC);
        reply.setThumbMediaId("MEDIA_ID");
        reply.setDescription("DESCRIPTION");
        reply.setTitle("TITLE");
    ...
    public void testNewsReply() {
        WxMpKefuMessage reply = new WxMpKefuMessage();
        reply.setToUser("OPENID");
        reply.setMsgType(WxConstant.KefuMsgType.NEWS);
