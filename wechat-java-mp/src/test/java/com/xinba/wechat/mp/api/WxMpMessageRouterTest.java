...
import com.xinba.wechat.common.session.StandardSessionManager;
...
public class WxMpMessageRouterTest {
    ...
    public void prepare(boolean async, StringBuffer sb, WxMpMessageRouter router) {
        router.rule()
                .async(async)
                .msgType(WxConstant.XmlMsgType.TEXT).event(WxConstant.EventType.CLICK).eventKey("KEY_1").content("CONTENT_1")
                .handler(new WxEchoMpMessageHandler(sb, "COMBINE_4"))
                .end()
                .rule()
                .async(async)
                .msgType(WxConstant.XmlMsgType.TEXT).event(WxConstant.EventType.CLICK).eventKey("KEY_1")
                .handler(new WxEchoMpMessageHandler(sb, "COMBINE_3"))
                .end()
                .rule()
                .async(async)
                .msgType(WxConstant.XmlMsgType.TEXT).event(WxConstant.EventType.CLICK)
                .handler(new WxEchoMpMessageHandler(sb, "COMBINE_2"))
                .end()
                .rule().async(async).msgType(WxConstant.XmlMsgType.TEXT).handler(new WxEchoMpMessageHandler(sb, WxConstant.XmlMsgType.TEXT)).end()
                .rule().async(async).event(WxConstant.EventType.CLICK).handler(new WxEchoMpMessageHandler(sb, WxConstant.EventType.CLICK)).end()
    ...
    public Object[][] messages2() {
        ...
        message1.setMsgType(WxConstant.XmlMsgType.TEXT);

        WxMpXmlMessage message2 = new WxMpXmlMessage();
        message2.setEvent(WxConstant.EventType.CLICK);
        ...
        c2.setMsgType(WxConstant.XmlMsgType.TEXT);
        c2.setEvent(WxConstant.EventType.CLICK);

        WxMpXmlMessage c3 = new WxMpXmlMessage();
        c3.setMsgType(WxConstant.XmlMsgType.TEXT);
        c3.setEvent(WxConstant.EventType.CLICK);
        c3.setEventKey("KEY_1");

        WxMpXmlMessage c4 = new WxMpXmlMessage();
        c4.setMsgType(WxConstant.XmlMsgType.TEXT);
        c4.setEvent(WxConstant.EventType.CLICK);
        c4.setEventKey("KEY_1");
        c4.setContent("CONTENT_1");

        return new Object[][]{
                new Object[]{message1, WxConstant.XmlMsgType.TEXT + ","},
                new Object[]{message2, WxConstant.EventType.CLICK + ","},
