...
public class WxMpMaterialServiceImplTest {
    ...
    public Object[][] mediaFiles() {
        return new Object[][]{
                new Object[]{WxConstant.MediaFileType.IMAGE, TestConstants.FILE_JPG, "mm.jpeg"},
                new Object[]{WxConstant.MediaFileType.VOICE, TestConstants.FILE_MP3, "mm.mp3"},
                new Object[]{WxConstant.MediaFileType.VIDEO, TestConstants.FILE_MP4, "mm.mp4"},
                new Object[]{WxConstant.MediaFileType.THUMB, TestConstants.FILE_JPG, "mm.jpeg"}
        };
    }
    ...
    public void testUploadMaterial(String mediaType, String fileType, String fileName) throws WxErrorException, IOException {
        ...
        try (InputStream inputStream = ClassLoader
            ...
            if (WxConstant.MediaFileType.VIDEO.equals(mediaType)) {
            ...
            if (WxConstant.MediaFileType.IMAGE.equals(mediaType)
                    || WxConstant.MediaFileType.THUMB.equals(mediaType)) {
                assertNotNull(res.getUrl());
            }

            if (WxConstant.MediaFileType.THUMB.equals(mediaType)) {
    ...
    public void testMaterialFileList() throws WxErrorException {
        WxMpMaterialFileBatchGetResult wxMpMaterialVoiceBatchGetResult = this.wxService.getMaterialService().materialFileBatchGet(WxConstant.MaterialType.VOICE, 0, 20);
        WxMpMaterialFileBatchGetResult wxMpMaterialVideoBatchGetResult = this.wxService.getMaterialService().materialFileBatchGet(WxConstant.MaterialType.VIDEO, 0, 20);
        WxMpMaterialFileBatchGetResult wxMpMaterialImageBatchGetResult = this.wxService.getMaterialService().materialFileBatchGet(WxConstant.MaterialType.IMAGE, 0, 20);
    ...
    public void testUploadMedia(String mediaType, String fileType, String fileName) throws WxErrorException, IOException {
        try (InputStream inputStream = ClassLoader.getSystemResourceAsStream(fileName)) {
            ...
            if (res.getMediaId() != null && !mediaType.equals(WxConstant.MediaFileType.VIDEO)) {
                //video 不支持下载，所以不加入
